...
def get_graph(train=False):
    ...
    with g.as_default():
            ...
            with g.name_scope('inputs'):
                i = get_tensor(shape=(batch_size, 52,52,128), name='data', dtype=FQDtype.FXP16, trainable=False)
            ...
            #             s_dtype=FixedPoint(16, 9), bn_dtype=FixedPoint(16, 8), stride=(1, 2, 2, 1))
            ...
            #     layer10 = yolo_convolution(i, filters=128, kernel_size=3,
            #             batch_normalize=True, act='leakyReLU',
            #             w_dtype=FixedPoint(16, 12), c_dtype=FixedPoint(16, 12),
            #             s_dtype=FixedPoint(16, 9), bn_dtype=FixedPoint(16, 8))
            ...
            #     layer14 = concat((layer12, layer13), 3)

            with g.name_scope('conv9'):
                layer15 = yolo_convolution(i, filters=128, kernel_size=1,
                        batch_normalize=True, act='leakyReLU',
                        w_dtype=FixedPoint(16, 12), c_dtype=FixedPoint(16, 12),
                        s_dtype=FixedPoint(16, 9), bn_dtype=FixedPoint(16, 8))
            ...
            #     layer22 = concat((layer20, layer21), 3)
            ...
            #     layer29 = yolo_convolution(layer28, filters=255, kernel_size=1,
            ...
            #     layer34 = concat((layer23, layer33), 3)
            ...
            #     layer36 = yolo_convolution(layer35, filters=255, kernel_size=1,
            #             batch_normalize=False, act='linear',
            #             w_dtype=FixedPoint(16, 12), c_dtype=FixedPoint(16, 12),
            #             s_dtype=FixedPoint(16, 9), bn_dtype=FixedPoint(16, 8))
