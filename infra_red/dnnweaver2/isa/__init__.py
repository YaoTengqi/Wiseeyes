...
class ComputeCal(ComputeInstruction):
    def __init__(self, src0_addr, imm, dest_addr):
        fn = FNCodes.MVHI#4
        super(ComputeCal, self).__init__(fn, 1, src0_addr, dest_addr, imm=imm, src1_addr=None)
...
class Int8_Ctr_Instruction(BFInstruction):
    def __init__(self, scratchpad_ID, index, address):
        # print('Scratchpad: {}; address: {}'.format(scratchpad_ID, address))
        self.scratchpad_ID = scratchpad_ID
        self.index = index
        ...
        op_spec = self.scratchpad_ID << 3
        op_spec += self.index
        BFInstruction.__init__(self, OPCodes.INT8_CTL, op_spec, 0, immediate)
    ...
    def get_binary(self):
        ...
        self.immediate = addr_index % (1 << 16)
        self.loop_id = (addr_index >> 16) % (1 << 5)
        return super(Int8_Ctr_Instruction, self).get_binary()


class Pad_lines_Instruction(BFInstruction):
    def __init__(self, scratchpad_ID, index, address):
        # print('Scratchpad: {}; address: {}'.format(scratchpad_ID, address))
        self.scratchpad_ID = scratchpad_ID
        self.index = index
        ...
        op_spec = self.scratchpad_ID << 3
        op_spec += self.index
        BFInstruction.__init__(self, OPCodes.pad_lines, op_spec, 0, immediate)
    ...
    def get_binary(self):
        ...
        self.immediate = addr_index % (1 << 16)
        self.loop_id = (addr_index >> 16) % (1 << 5)
        return super(Pad_lines_Instruction, self).get_binary()  

class RSHIFT_NUM_Instruction(BFInstruction):
    def __init__(self, scratchpad_ID, index, address):
        # print('Scratchpad: {}; address: {}'.format(scratchpad_ID, address))
        self.scratchpad_ID = scratchpad_ID
        self.index = index
        ...
        op_spec = self.scratchpad_ID << 3
        op_spec += self.index
        BFInstruction.__init__(self, OPCodes.RSHIFT_NUM, op_spec, 0, immediate)
    ...
    def get_binary(self):
        ...
        self.immediate = addr_index % (1 << 16)
        self.loop_id = (addr_index >> 16) % (1 << 5)
        return super(RSHIFT_NUM_Instruction, self).get_binary()   
