...
def get_graph(train=False):
    ...
    with g.as_default():
        ...
        with g.name_scope('conv1'):
            conv1 = yolo_convolution(conv0, filters=32, kernel_size=3,
                    batch_normalize=False, act='ReLU',
                    w_dtype=FixedPoint(16,13), c_dtype=FixedPoint(16,8),
                    s_dtype=FixedPoint(16,13), bn_dtype=FixedPoint(16,8))
        with g.name_scope('pool0'):
            pool0 = maxPool(conv1, pooling_kernel=(1,2,2,1), stride=(1,2,2,1), pad='VALID')

        with g.name_scope('conv2'):
            conv2 = yolo_convolution(pool0, filters=32, kernel_size=3,
                    batch_normalize=False, act='ReLU',
                    w_dtype=FixedPoint(16,13), c_dtype=FixedPoint(16,8),
                    s_dtype=FixedPoint(16,13), bn_dtype=FixedPoint(16,8))
        with g.name_scope('conv3'):
            conv3 = yolo_convolution(conv2, filters=32, kernel_size=3,
                    batch_normalize=False, act='ReLU',
                    w_dtype=FixedPoint(16,13), c_dtype=FixedPoint(16,8),
                    s_dtype=FixedPoint(16,13), bn_dtype=FixedPoint(16,8))
        ...
        with g.name_scope('conv4'):
            conv4 = yolo_convolution(pool1, filters=32, kernel_size=3,
                    batch_normalize=False, act='ReLU',
                    w_dtype=FixedPoint(16,13), c_dtype=FixedPoint(16,8),
                    s_dtype=FixedPoint(16,13), bn_dtype=FixedPoint(16,8))
        with g.name_scope('conv5'):
            conv5 = yolo_convolution(conv4, filters=32, kernel_size=3,
                    batch_normalize=False, act='ReLU',
                    w_dtype=FixedPoint(16,13), c_dtype=FixedPoint(16,8),
                    s_dtype=FixedPoint(16,13), bn_dtype=FixedPoint(16,8))
