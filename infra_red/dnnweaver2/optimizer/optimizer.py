...
def optimize_for_order(conv_params, pool_kernel=None, pool_stride=None, sequential=True,first_layer=False):
    ...
    if not sequential:
        _bound_optimizer_method = functools.partial(_optimize_for_order, conv_params_with_pool,first_layer)
...
def _optimize_for_order(conv_params,first_layer, order_type, verbose=False):
    """
    ...
    pool_O = (O - pool_kernel[2]) / pool_stride[2] + 1  #��τ1e
    pool_Oh = (O_h - pool_kernel[1]) / pool_stride[1] + 1  # ��τ1e
